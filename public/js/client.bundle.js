	  ...
	  _createClass(App, [{
	    ...
	    value: function fetchImages() {
	      ...
	      fetch(url).then(function (response) {
	        ...
	        var images = jsonData;
	        var getNumber = _this2.randomIntFromInterval(0, images.length);
	
	        var width = images[getNumber].width,
	            height = images[getNumber].height,
	            id = images[getNumber].id;
	
	        var imageSrc = 'http://unsplash.it/' + width + '/' + height + '?image=' + id;
